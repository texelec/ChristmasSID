//Code added by TexElec / Kevin Williams is marked with my name. 
//75_LED.ino  & 83_button_LIGHT.ino were also added for the LED routines & forth button.
//https://texelec.com - 2021
...
//Modified by Kevin Williams to only play files in root, to keep it easy
const char * const HVSC = "" ;                       // ---> IMPORTANT! <---  name of HVSC SID Collection folder on your SD Card ("HVSC", "C64Music", "/" or "" for root, etc"
...
#define NUMBER_OF_FOLDERS 1                             // set number of folder for playlist. Must have at least 1.
...
#define BUTTON_PREV     PA11                // PREV          // If defined, it will have function from table bellow. Can be commented out
#define BUTTON_PLAY     PA10                // PLAY          // If defined, it will have function from table bellow. Can be commented out
#define BUTTON_NEXT     PA9                 // NEXT          // If defined, it will have function from table bellow. Can be commented out
#define BUTTON_LIGHT    PA12                // LED Control button - Added by Kevin Williams for Christmas SID
#define AMP_MUTE        PB15                // PAM8302 Amp Mute, High=ON, Low=MUTE - Added by Kevin Williams for Christmas SID
